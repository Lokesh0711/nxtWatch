...
import GamingVideoItemGenerater from '../GamingVideoItemGenerater'
      ...
      <ThemeContext.Consumer>
        {value => {
          ...
          return (
            <>
              <Header />
              <MainContainer darkMode={isDark} data-testid="gaming">
                <SideNavBar />
                <ContentContainer darkMode={isDark}>
                  <TitleContainer darkMode={isDark}>
                    ...
                    <Title darkMode={isDark}>Gaming</Title>
                  </TitleContainer>
